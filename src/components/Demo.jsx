  ...
  return (
    <section className="mt-16 w-full max-w-xl">
      ...
      <div className="flex flex-col w-full gap-2">
        ...
        >
          <input type="number" placeholder="Enter How Many Paragraphs" value={length} onChange={(e) => setLength(e.target.value)} required className="length_input" />
          <img src={ linkIcon } alt="link_icon" className="absolute left-0 top-12 mt-3.5 ml-3 w-5"/>
